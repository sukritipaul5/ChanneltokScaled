...
if __name__ == "__main__":
    ...
    quantizer = FSQQuantizer2(levels=levels, dim=512, num_codebooks=1, quantize_channels=False)
    ...
    quantizer = FSQQuantizer2(levels=levels, dim=16, num_codebooks=1, quantize_channels=True)
